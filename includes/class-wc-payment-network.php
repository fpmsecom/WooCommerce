    ...
    public function init_form_fields() {
        $this->form_fields = array(
            ...
            'merchantID' => array(
                ...
                'type'        => 'text',
                'description' => __('Please enter your '.$this->method_title.' merchant ID.  Use 121057 for testing only.', $this->lang),
            ...
            'signature' => array(
                ...
                'type'        => 'text',
                'description' => __('Please enter the signature key for the merchant account. Use gtlnofMTzfL5 for testing only.', $this->lang),
            ...
            'gatewayURL' => array(
                ...
                'type'        => 'text',
                'description' => __('Please enter your gateway URL.  This should be '.$this->default_gateway_url.' unless otherwise specified', $this->lang),
                'default' => $this->default_gateway_url,
                'custom_attributes' => [
                    'required' => true,
                ],
            ),
...
FORM;
    ...
    protected function capture_order($order_id) {
        ...
        if ($this->settings['customerWalletsEnabled'] === 'Y' && is_user_logged_in()) {
            ...
            global $wpdb;
            $wallet_table_name = $wpdb->prefix.'woocommerce_firstpayments_wallets';
...
SCRIPT;
    ...
    protected function create_wallet($response) {
        ...
        if ($this->settings['customerWalletsEnabled'] === 'Y' && isset($response['walletID']) && $order->get_user_id() != 0) {
            $wallet_table_name = $wpdb->prefix.'woocommerce_'.'firstpayments_'.'wallets';
